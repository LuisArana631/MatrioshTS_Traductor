...
export class resta extends expresion_c3d{
    ...
    public traducir(env_: ambiente_c3d, generador_:generador, errores_:Array<nodoError>):retorno{
        try{
            ...
            switch(tipo_guia){
                ...
                default:
                    errores_.push(new nodoError("Semántico", `No se puede restar ${left_.tipo_.tipo} - ${right_.tipo_.tipo}`, this.linea_, this.columna_, "Resta"));
                    break;
            }
        }catch(error){
